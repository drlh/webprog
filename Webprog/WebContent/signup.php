...
<head>
    ...
    <title>AR:chitecture e.V. | Registrieren </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Registrieren Sie sich jetzt!</h2>
                    <h3 class="section-subheading text-muted" style="color: #fff;">Wir benötigen nur ein paar Daten.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="E-Mail *" name="email" id="email" required data-validation-required-message="Bitte geben Sie eine g&uuml;ltige E-Mail ein.">
                                    <p class="help-block text-danger"></p>
                                </div>
								<div class="form-group">
                                    <input type="password" class="form-control" placeholder="Passwort *" name="password" id="password" required data-validation-required-message="Bitte geben Sie ein Passwort ein.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Mitgliedsnummer *" name="number" id="number" required data-validation-required-message="Bitte geben Sie Ihre Mitgliedsnummer ein.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" class="btn btn-xl">Registrieren</button>
                            </div>
                        </div>
                    </form>
                </div>
